...
namespace CocaCopa {
    public class Utilities {
        ...
        /// <param name="continuous">Set to true if you want the timer to automatically reset</param>
        /// <returns>True, when the timer value is 0</returns>
        public static bool TickTimer(ref float waitTimer, float waitTime, bool continuous = true) {
            if (waitTimer == 0) {
                if (continuous)
                waitTimer = waitTime;
                return true;
